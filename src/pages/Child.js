        ...
        <div className='w-full mx-auto my-48 max-w-xl bg-gradient-to-tr to-purple-100 from-cyan-100 p-2 rounded-md shadow-2xl'>
            <div className='bg-white rounded-md p-10'>
                ...
                <div className='flex justify-center gap-5'>
                    <button onClick={()=>setCount(count-1)} className='py-2 px-3 bg-purple-200 rounded-md '>Decrement</button>
                    <button onClick={()=>setCount((prvState)=>prvState+1)}  className='py-2 px-3 bg-cyan-200 rounded-md '>Increment</button>
                </div>
            </div>
        </div>
    );
